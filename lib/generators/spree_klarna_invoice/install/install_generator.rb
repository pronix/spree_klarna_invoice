...
module SpreeKlarnaInvoice
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def add_javascripts
        append_file 'app/assets/javascripts/store/all.js', "//= require store/spree_klarna_invoice\n"
        append_file 'app/assets/javascripts/admin/all.js', "//= require admin/spree_klarna_invoice\n"
      end
